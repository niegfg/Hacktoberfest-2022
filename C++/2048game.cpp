...
//calculates and updates for left move
...
//checking if we can add 2 blocks or not 
...
//to display gameover or not (adjacent node values have to be considered)
